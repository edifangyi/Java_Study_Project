...
_st_dest="http://"+_st_ip+_st_dest_path+"&uv="+_st_uv+"&nuv="+_st_nuv+"&cna="+_st_cna+"&cg="+_st_cg+"&mid="+_st_mid+"&mmland="+_st_mm_land+"&ade="+_st_ade_value+"&adtm="+_st_ade_adtime+"&sttm="+_st_ade_sttime+"&cpa="+_st_cpa+"&ss="+_st_ss+"&usn="+_st_url_sn+"&ec="+_en_co+"&ref="+_st_ref+"&url="+_st_url+"&dom="+_st_dom+"&host="+_st_host+"&nac="+_st_sof+"&agt="+_st_agt+"&clr="+_st_clr+"&scr="+_st_scr+"&lng="+_st_lng+"&jvm="+_st_jvm+"&flu="+_st_flu+"&tm=1223267104"+"&tc=5534c6ab"+"&ut=0"+"&cnu="+_st_cva;

document.open();
if(_st_dom == "367art.org" || _st_dom == "367art.com" || _st_dom == "100wz.com.cn" || _st_dom == "175fd.com" || _st_dom == "1goo.net" || _st_dom == "1kpp.cn" || _st_dom == "kankanso.cn" || _st_dom == "wuwx.cn" || _st_dom == "wwwcome.cn" || _st_dom == "allasp.cn" || _st_dom == "iiseo.com"){
}
else{
